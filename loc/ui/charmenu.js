export default {
  ...
  create: {
    ...
    nameReq: {
      ...
      ko: '이름은 최대 16자 까지이며 공백 없이 a-Z와 0-9의 문자만 사용할 수 있습니다.',
      ...
      zh: '您的名稱只能包含字符a-Z和數字0-9，不能包含任何空格。3到16個字元之間。'
  ...
  delete: {
    ...
    info: {
      ...
      ko: '삭제하려면 캐릭터의 이름을 입력해주세요. 삭제된 캐릭터는 다시 복구할 수 없습니다.',
